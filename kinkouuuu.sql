...
(3, 'A', 'BALIKPAPAN', '0265', '2021-09-20 17:36:05', '2021-09-20 17:36:05');
...
(2, 'KURO', 'ANJING', 1, '2021-09-19 18:11:14', '2021-09-19 21:17:24'),
(3, 'ASYA', 'KUCING', 2, '2021-09-19 18:19:44', '2021-09-19 22:30:35'),
(4, 'ABIL', 'KUCING', 2, '2021-09-19 23:18:31', '2021-09-19 23:18:31'),
(5, 'LYLYX', 'ANJING', 1, '2021-09-19 23:18:56', '2021-09-19 23:18:56');
...
(1, 1, 5, 1, '2021-09-19 22:30:04', '2021-09-20 22:18:13'),
(2, 2, 4, 2, '2021-09-19 23:23:32', '2021-09-19 23:23:32'),
(3, 3, 1, 1, '2021-09-20 18:49:04', '2021-09-20 19:08:10'),
(4, 3, 1, 1, '2021-09-20 18:49:16', '2021-09-20 18:49:16'),
(5, 1, 3, 2, '2021-09-20 19:50:43', '2021-09-20 19:50:51'),
(6, 3, 1, 1, '2021-09-21 00:09:01', '2021-09-21 00:09:01');

-- --------------------------------------------------------

--
-- Table structure for table `layanan_penitipan`
--

CREATE TABLE `layanan_penitipan` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `hewan_id` bigint(20) NOT NULL,
  `customer_id` bigint(20) NOT NULL,
  `tglin` date NOT NULL,
  `tglout` date NOT NULL,
  `biayatitip` double NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `layanan_penitipan`
--

INSERT INTO `layanan_penitipan` (`id`, `hewan_id`, `customer_id`, `tglin`, `tglout`, `biayatitip`, `created_at`, `updated_at`) VALUES
(1, 3, 2, '2021-09-07', '2021-09-14', 2000000, '2021-09-21 16:43:26', '2021-09-21 16:48:50'),
(2, 1, 1, '2021-09-07', '2021-09-21', 1000000, '2021-09-21 16:44:14', '2021-09-21 16:44:14');
...
(1, 'Muntah Kuning', 'Kucing selalu muntah kuning sehabis makan dan minum', '2021-09-19 21:40:35', '2021-09-19 21:40:35'),
(2, 'FEI', 'Kucing dengan gejala demam, depresi, dll', '2021-09-20 19:41:24', '2021-09-20 19:41:24');
...
--
-- Indexes for table `layanan_penitipan`
--
ALTER TABLE `layanan_penitipan`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `layanan_penitipan`
--
ALTER TABLE `layanan_penitipan`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
