            ...
            <div class="card-body">
              <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td>{{ $item->tglin }}</td>
                    <td>{{ $item->tglout }}</td>
                    <td>{{ $item->biayatitip }}</td>
                    <td>
                        <a href="{{ url('penitipan/edit-layanan-penitipan',$item->id) }}"><i class="fas fa-edit"></i></a> | <a href="{{ url('penitipan/delete-layanan-penitipan',$item->id) }}"><i class="fas fa-trash-alt" style="color: red"></i></a>
                    </td>
                  </tr>
                  @endforeach
              </table>
